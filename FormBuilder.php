...
class FormBuilder {
    ...
    /**
     * Create a new create based form builder.
     *
     * @param  mixed  $model
     * @param  array  $options
     * @return string
    ...
    public function select($name, $list = array(), $selected = null, $options = array())
    {
        ...
        {
           $list = array_merge(['' => '('.$options['empty'].')'], $list);
            unset($options['empty']);
        }
    ...
    public function button($value = null, $attributes = array())
    {
        ...
        $attributes = option_add($attributes, 'class', 'btn');
        $icon = isset($attributes['icon']) ? icon($attributes['icon']) . ' ' : '';
        return '<button'.$this->html->attributes($attributes).'>'.$icon.$value.'</button>';
    }
